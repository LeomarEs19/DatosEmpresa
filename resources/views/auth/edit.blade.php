            ...
            <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
                ...
                <form action="{{route('cursos.update', $curso=>id)}}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="number" name="card" id="card" placeholder="Cedula" class="border p-3 w-full rounded-lg @error('card')
                        border-red-500 
                        @enderror">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="address" id="address" placeholder="Direccion" class="border p-3 w-full rounded-lg @error('address')
                        border-red-500 
                        @enderror">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="number" name="phone" id="phone" placeholder="Telefono" class="border p-3 w-full rounded-lg @error('phone')
                        border-red-500 
                        @enderror">
                    ...
                    <input type="submit" value="Actualizar" class=" cuenta bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white">
                </form>
            </div>
        </div>
